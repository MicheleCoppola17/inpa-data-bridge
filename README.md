...
Exam payloads include `short_title`, `short_description`, `settore`, `municipality`, `region`, `province`, `url`, `salary_range`, and `selection_criteria` for cleaner presentation.
...
- `settore` (e.g. `Amministrativo e Contabile`)
